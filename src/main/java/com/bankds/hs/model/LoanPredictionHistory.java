...
@Entity
@Table(name = "hs_loan_prediction_history ", schema = "public")
@NamedQuery(name = "LoanPredictionHistory.findAll", query = "SELECT g FROM LoanPredictionHistory g")
public class LoanPredictionHistory implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "loan_id")
	@SequenceGenerator(name = "hs_loan_prediction_history_loan_id_seq", sequenceName = "hs_loan_prediction_history_loan_id_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "hs_loan_prediction_history_loan_id_seq")
	private int loanId;
